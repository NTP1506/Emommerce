...
{
    public partial class dbCommerce : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    Thump = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_CartID", x => x.CatID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attributes_AttributesPrices",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductID = table.Column<int>(type: "int", nullable: true),
                    OrderNuber = table.Column<int>(type: "int", nullable: true),
